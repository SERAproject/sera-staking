...
.loading-spinner:after {
  ...
  height: 50px;
  margin: 0 auto;
  border-bottom: 3px solid #bea069;
  border-top: 3px solid #bea069;
  border-radius: 50%;
...
.round .round-card hr { background: rgb(255 255 255); }
@media (max-width: 768px) {
...
.advisor-card .round-card-body svg { color: #fff; margin-right: 1em; }
...
.tabs-card .round-card hr { background: rgb(255 255 255); }
...
.checkpoints .round-card hr { background: rgb(255 255 255); }
